<div class=" mw-15 w-15 nav-panel m-0 p-0">
    ...
    <nav class='nav-panel-options'>
            <ul class='fw-600 ls-13'>
                ...
                <li><a class='pl-4' href="../formaspago/actualizarformaspago.php">Actualizar Formas de Pago</a></li>
                <li><a class='pl-4' href="../tipopedido/actualizartipospedido.php">Actualizar Tipos de pedido</a></li>
            </ul>
    </nav>
