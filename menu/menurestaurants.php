        ...
        <ul>
            ...
            <li><a href="nosotros.php?view=<?php echo $idRestaurante ?>" class="op2 h-100">Nosotros</a></li>
                <?php if ($profileManager == true) { ?>
                    <li><a href="panel/paginabienvenida.php?view=<?php echo $idRestaurante ?>" class='h-100'>Panel</a></li>
                <?php } ?> 
            <li>
    ...
    <div class="contenedor-general">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-restaurant-list navbar-nav mr-auto text-center fs-18">
                ...
                <?php if ($profileManager == true) { ?>
                    <li class='d-flex'><a class='text-white w-100 py-2' href="panel/paginabienvenida.php?view=<?php echo $idRestaurante ?>">Panel</a></li>
                <?php } ?> 
                <li class='d-flex'>
